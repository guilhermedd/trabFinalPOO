...
public class PostDAO {
    ...
    private PostDAO() throws ClassNotFoundException, SQLException, SelectException{
        ...
        delete = connection.prepareStatement("delete from post where id_post = ?;delete from commentary where id_post = ?");
    ...
    public void update(Post post) throws UpdateException {
        try {
            ...
            update.setBytes(2, post.getImage());
    ...
    public void insert(Post post, User user) throws InsertException, SelectException {
        try {
            ...
            insert.setBytes(2, post.getImage());
